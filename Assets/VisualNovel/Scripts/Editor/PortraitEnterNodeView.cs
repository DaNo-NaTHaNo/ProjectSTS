...
public class PortraitEnterNodeView : NodeView
{
    public PortraitEnterNodeView() : base("Portrait Enter", true, true)
    {
        titleContainer.style.backgroundColor = new Color(35f / 255f, 35f / 255f, 140f / 255f);
        ...
        extensionContainer.Add(new UndoableColorField("startTint", "Change startTint") { name = "startTint", value = Color.clear });
        ...
        style.minHeight = 30f + (11 * 22f);
        style.maxHeight = 30f + (11 * 22f);
        style.minWidth = 240;
    }
    ...
    public override BaseNodeFields SaveData()
    {
        ...
        return new PortraitEnterNodeFields
        {
    ...
    public override void LoadData(BaseNodeFields data)
    {
        ...
        var pData = data as PortraitEnterNodeFields;
        if (pData != null)
        {
            ...
            if (pData.startTint != null)
            {
                var startTintColor = new Color(pData.startTint.r, pData.startTint.g, pData.startTint.b, pData.startTint.a);
