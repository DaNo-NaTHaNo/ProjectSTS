...
public class PortraitExitNodeView : NodeView
{
    public PortraitExitNodeView() : base("Portrait Exit", true, true)
    {
        titleContainer.style.backgroundColor = new Color(0f / 255f, 0f / 255f, 98f / 255f);
        ...
        extensionContainer.Add(new UndoableColorField("endTint", "Change endTint") { name = "endTint", value = Color.black });
    ...
    public override BaseNodeFields SaveData()
    {
        ...
        return new PortraitExitNodeFields
        {
    ...
    public override void LoadData(BaseNodeFields data)
    {
        ...
        var pData = data as PortraitExitNodeFields;
        if (pData != null)
        {
