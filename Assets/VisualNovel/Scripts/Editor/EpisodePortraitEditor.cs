...
public class EpisodePortraitEditor : EditorWindow
{
    ...
    private void OnExportButtonClicked()
    {
        ...
        try
        {
            string csvText = CsvUtilityVN.GenerateEpisodePortraits(_targetData.episodePortraits);
            File.WriteAllText(path, csvText, System.Text.Encoding.UTF8);
            Debug.Log($"EpisodePortrait �����Ͱ� ���������� Export �Ǿ����ϴ�: {path}");
        }
        catch (Exception e)
        {
    ...
    {
        // [����] Undo.RegisterCompleteObjectUndo�� ����Ͽ� SO ��ü ���¸� ���
    ...
    private void OnImportButtonClicked()
    {
        ...
        if (!string.IsNullOrEmpty(path))
        {
            ...
            _targetData.episodePortraits = CsvUtilityVN.ParseEpisodePortraits(csvText);
            EditorUtility.SetDirty(_targetData);
            RefreshListView();
        }
    }
    ...
    private void SetupHeader()
    {
        ...
        AddHeaderLabel("portraitID", "header-speakerPortrait"); // Ŭ���� ��Ȱ��
        AddHeaderLabel("portraitName", "header-speakerName"); // Ŭ���� ��Ȱ��
