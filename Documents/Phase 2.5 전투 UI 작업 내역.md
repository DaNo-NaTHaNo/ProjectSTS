...
- [x] ~~BattleScene에 Canvas + 각 UI 컴포넌트 프리팹 배치 (에디터 작업)~~ — MCP for Unity로 완료
- [x] ~~BattleUIController에 하위 컴포넌트 SerializeField 할당~~ — 10개 필드 전부 할당 완료
- [ ] UIHandArea._cardPrefab에 UICard.prefab GUID (`c15e3d138c407a6429e2de2b663eef6f`) 할당 필요
- [ ] UIBattleUnitPanel._statusIconPrefab에 UIStatusIcon.prefab GUID (`a12d84700289038449ea05f39340089b`) 할당 필요
- [x] ~~UIBattleUnitPanel 프리팹: UIUnitPortrait, UIHPBar, UIStatusIcon, UIElementBadge 배치~~ — 프리팹 생성 완료 (`Assets/_Project/Prefabs/UI/Battle/UIBattleUnitPanel.prefab`)
